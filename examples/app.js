...
function program1(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</h1>\n    <p class=\"float\">\n      <label for=\"login\"><i class=\"fa fa-user\"></i>用户名：</label>\n      ");
...
Ember.Menglifang.LoginFormComponent = Ember.Component.extend({
  ...
  actions: {
    login: function() {
      return console.log('login form submit');
    }
  }
});
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  },hashTypes:{'title': "STRING",'copyright': "STRING",'supportedBrowers': "ID"},hashContexts:{'title': depth0,'copyright': depth0,'supportedBrowers': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "login-form", options))));
  data.buffer.push("\n");
  return buffer;
